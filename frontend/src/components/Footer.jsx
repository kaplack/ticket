...
function Footer() {
  return (
    ...
    {/* <footer className="footer-dark" style={{ backgroundImage: `url(${publicUrlFor("images/f-bg.jpg")})` }}> */}
        <footer className="footer-dark" style={{backgroundColor: '#080F16'}}>
                                ...
                                <div className="row">
                                    <div className="col-lg-3 col-md-6 col-sm-6">
                                        <div className="widget widget_services ftr-list-center">
                                            ...
                                            <ul>
                                                <li><NavLink >User Dashboard</NavLink></li>
                                                <li><NavLink >Candidates</NavLink></li>
                                                <li><NavLink >Blog List</NavLink></li>
                                                <li><NavLink >Blog single</NavLink></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-lg-3 col-md-6 col-sm-6">
                                        <div className="widget widget_services ftr-list-center">
                                            ...
                                            <ul>
                                                <li><NavLink >Blog Grid</NavLink></li>
                                                <li><NavLink >Contact</NavLink></li>
                                                <li><NavLink >Jobs Listing</NavLink></li>
                                                <li><NavLink >Jobs details</NavLink></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div className="col-lg-3 col-md-6 col-sm-6">
                                        <div className="widget widget_services ftr-list-center">
                                            ...
                                            <ul>
                                                ...
                                                <li><NavLink >Employer</NavLink></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
