...
function EmpProfilePage() {
  ...
  useEffect(() => {
    if (employer) {
      setLogo(
        employer.logo && employer.logo.length > 0 ? employer.logo[0] : ""
      );
      setCover(
        employer.cover && employer.cover.length > 0 ? employer.cover[0] : ""
      );
  ...
  const handleSubmit1 = (e) => {
    ...
    dispatch(updateProfile(formData))
      ...
      .catch((error) => {
        toast.error(
          error.message || "An error occurred while updating the work."
        );
      });
  };
          ...
          <div className="row">
              ...
              <div className="form-group">
                <div className="dashboard-profile-pic">
                  <div className="dashboard-profile-photo">
                    <img
                      src={previewLogo || logo.relativePath || defaultLogo}
                      alt=""
                    />
                  ...
                  <p>
                    <b>Logo de la compañia :- </b> Tamaño mínimo: 136 x 136 y
                    archivos en formato .jpg &amp; .png
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-12 col-md-12">
              <div className="dashboard-cover-pic">
                ...
                <p>
                  <b>Imagen del Banner :- </b> Tamaño mínimo: 770 x 310 y
                  archivos en formato .jpg &amp; .png
                </p>
              </div>
            </div>
                ...
                <div className="form-group">
                  ...
                  <div className="ls-inputicon-box">
                    ...
                    >
                      ...
                      <option
                        value="Publica"
                        selected={compType === "Publica" ? true : false}
                      >
                        Publica
                      </option>
                      <option
                        value="Privada"
                        selected={compType === "Privada" ? true : false}
                      >
                        Privada
                      </option>
                    </select>
                ...
                <div className="form-group">
                  ...
                  <div className="ls-inputicon-box">
                    <input
                      ...
                      name="idNumber"
                      type="text"
                      placeholder="Ingrese su múmero de RUC"
                      value={idNumber}
              ...
              <div className="col-md-12">
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    name="description"
                    rows={3}
                    placeholder="Saludos! Somos una empresa con ideas innovadoras"
                    value={description}
